...
export async function PATCH(
  ...
  if (isFinal) {
    ...
    // Recalcula todas las predicciones. Los Scores de QUINIELA_ADMIN se
    // CONSERVAN pero las posiciones los ignoran (filtran por role PARTICIPANT),
    // así que no afectan puntos ni ranking.
